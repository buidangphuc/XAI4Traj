...
from .transformer import TransformerBlock, build_model

NAME = "transformer_model"
DEFAULT_OPTIMIZER_PARAMS = {'lr': 1e-2}
DEFAULT_PATIENCE = 10


class TransformerModel(Model):
    """Implementation of a Transformer model using PyTorch."""
    ...
    def _reshape_input(self, x_data: np.ndarray) -> np.ndarray:
        ...
        # The transformer can now handle both 3D and 4D inputs
        # We'll keep it as 3D (batch_size, seq_len, features) which is more standard
